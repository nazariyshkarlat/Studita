...
class UsersAdapter(var items: ArrayList<UsersRecyclerUiModel>,
    ...
    override fun onRequestMoreItems() {
        ...
        friendsFragmentViewModel.getUsers(userId, if(startsWith == null) friendsFragmentViewModel.sortBy else null, true, startsWith = friendsFragmentViewModel.searchState.let{
            startsWith
