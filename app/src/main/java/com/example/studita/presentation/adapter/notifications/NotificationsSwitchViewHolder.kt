...
class NotificationsSwitchViewHolder(view: View) : NotificationsViewHolder<NotificationsUiModel.NotificationsSwitch>(view){
    ...
    override fun bind(model: NotificationsUiModel) {
        ...
        with(itemView){
            ...
            this.setOnClickListener {
                notificationsLayoutSwitchItemSwitch.isChecked = !notificationsLayoutSwitchItemSwitch.isChecked
