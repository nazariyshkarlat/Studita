...
class PrivacySettingsDuelsExceptionsAdapter(var items: ArrayList<PrivacySettingsDuelsExceptionsRecyclerUiModel>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PrivacySettingsDuelsExceptionsViewHolder<out PrivacySettingsDuelsExceptionsRecyclerUiModel>{
    ...
    override fun onBindViewHolder(holder: PrivacySettingsDuelsExceptionsViewHolder<out PrivacySettingsDuelsExceptionsRecyclerUiModel>, position: Int) {
    ...
    override fun onRequestMoreItems() {
        privacySettingsDuelsExceptionsViewModel.getPrivacySettingsDuelsExceptions(UserUtils.getUserIDTokenData()!!, true)
    }
    ...
    override fun onExceptionSelect(userId: Int, userName: String, isException: Boolean) {
        ...
        privacySettingsDuelsExceptionsViewModel.editedDuelsExceptionsData.add(EditDuelsExceptionsData(!isException, userId, userName))
    }

}


abstract class PrivacySettingsDuelsExceptionsViewHolder<T : PrivacySettingsDuelsExceptionsRecyclerUiModel>(view: View) : RecyclerView.ViewHolder(view) {
