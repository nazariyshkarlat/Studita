...
sealed class NotificationsUiModel{
    ...
    class Notification(val userData: UserData, val notificationText: SpannableStringBuilder, val timeText: String, val notificationType: NotificationType) : NotificationsUiModel()
...
fun NotificationData.createNotificationText(context: Context): SpannableStringBuilder {
    ...
    builder.append(context.resources.getString(R.string.user_name_template, userName).createSpannableString(
    ...
    builder.append(" ")
    builder.append(context.resources.getString(when(notificationType) {
