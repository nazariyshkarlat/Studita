...
public class CenterIconTextView extends AppCompatTextView {
    ...
    public CenterIconTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CenterIconTextView);
            mTintColor = typedArray.getColor(R.styleable.CenterIconTextView_drawableTint, Color.TRANSPARENT);
            mDrawableSize = typedArray.getDimensionPixelSize(R.styleable.CenterIconTextView_drawableSize, -1);
