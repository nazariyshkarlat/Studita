...
data class IsMyFriendEntity(@SerializedName("is_my_friend")val isMyFriend: Boolean = false,
...
fun IsMyFriendEntity.toBusinessEntity() = IsMyFriendData(isMyFriend, friendshipRequestFromMe, friendshipRequestToMe)