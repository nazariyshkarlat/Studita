...
data class EditProfileEntity(@SerializedName("user_name")val userName: String?, @SerializedName("user_full_name")val userFullName: String?, @SerializedName("avatar_link")val avatarLink: String?)
