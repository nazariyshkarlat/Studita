...
data class EditProfileEntity(@SerializedName("user_name")val userName: String? = null, @SerializedName("name")val name: String?, @SerializedName("avatar_link")val avatarLink: String?)
