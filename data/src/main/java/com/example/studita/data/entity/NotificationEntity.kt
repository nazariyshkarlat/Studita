...
data class NotificationEntity(@SerializedName("user_id")val userId: Int,
...
fun NotificationEntity.toBusinessEntity() = NotificationData(userId, userName, avatarLink, notificationType.toNotificationType(), secondsAgo, isMyFriendEntity.toBusinessEntity())
