package com.studita.domain.entity.serializer
...
class IsMyFriendStatusDeserializer : JsonDeserializer<IsMyFriendStatus.Success> {
    ...
    override fun deserialize(
        ...
        return when (jsonObject.get("type").asString) {
            ...
            "waiting_for_friendship_accept" -> IsMyFriendStatus.Success.WaitingForFriendshipAccept(
                jsonObject.get("friend_id").asInt
            )
            "got_my_friendship_request" -> IsMyFriendStatus.Success.GotMyFriendshipRequest(
                jsonObject.get("friend_id").asInt
            )
