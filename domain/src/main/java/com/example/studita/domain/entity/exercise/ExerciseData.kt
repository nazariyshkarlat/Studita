...
sealed class ExerciseData(open val exerciseNumber: Int?){
    sealed class ExerciseDataExercise(override val exerciseNumber: Int, open val exerciseAnswer: String?): ExerciseData(exerciseNumber) {
        ...
        data class ExerciseType10Data(override val exerciseNumber: Int, val titleParts: List<String>, val subtitle: String, override val exerciseAnswer: String?) : ExerciseDataExercise(exerciseNumber, exerciseAnswer)
